<?php
	$soalapa="tentang_kami"; // menentukan tabel apa yang dipilih
	$menu_title = "Tentang Kami"; // menentukan judul halaman ini
		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<?php
						$id = '15';
						$satuan = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM tentang_kami WHERE id = '$id' ")); 
					?>
					...
					<div class="the-box">
						<form id="eventform" method="post" action="<?php echo $soalapa ?>_action.php?action=edit&id=<?php echo $id ?>" class="form-horizontal" enctype="multipart/form-data" >
                            ...
                            <?php file_gambar_update('../images/tentang_kami/',$satuan['image_banner'],'image','english') ?>
