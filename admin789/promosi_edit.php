<?php
	$soalapa="promosi"; // menentukan tabel apa yang dipilih
	$menu_title = "Promosi Sticky"; // menentukan judul halaman ini
				...
				<div class="container-fluid">
					...
					<div class="the-box">
						<form id="eventform" method="post" action="<?php echo $soalapa ?>_action.php?action=edit&id=<?php echo $id ?>" class="form-horizontal" enctype="multipart/form-data" >
							...
							<?php textbox_update('Link','link',$satuan['description']) ?>
							</fieldset>
