<?php
	...
	$page="dokumentasi"; // menentukan tabel apa yang dipilih
				...
				<div class="container-fluid">
					...
					<div class="the-box">
						<form id="myForm" method="post" action="<?php echo $page ?>_action.php?action=input" class="form-horizontal" enctype="multipart/form-data" >
							...
							<fieldset>
								<legend id="result"><?php echo $menu_detail_title ?></legend>								
								<?php textbox('Caption','title','') ?>	
								<?php file_input("Dokumen","file","masukan gambar disini") ?>                                
                                <?php textbox("Link", "link", "") ?>
							</fieldset>
