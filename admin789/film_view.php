				...
				<div class="container-fluid">
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<tbody>
								<?php
									$query = mysqli_query($con,"SELECT a.*, b.title as category_title FROM ".$soalapa." a INNER JOIN kategori_program b ON a.category_id = b.id ORDER BY id DESC");
									$no = 1;
									while ($satuan = mysqli_fetch_assoc($query)) {
										  ...
										  <div class="modal-dialog">
											<div class="modal-content">
											  <div class="modal-header">
												...
												<h4 class="modal-title" id="DefaultModalLabel"><center> Apakah Anda Yakin akan menghapus data <?php echo '" '.$satuan['judul'].' "' ?> ?</center>
											  </div>
										...
										<tr class="odd gradeX">
											...
											<td width="30%"><?php echo $satuan['judul'] ?></td>
											<td width="20%"><?php echo $satuan['category_title'] ?></td>
                                            <td width="10%"><?php echo $satuan['aktif']=='1'?'Aktif':'Tidak Aktif' ?></td>
											<td width="20%">
											<a target="_blank" href="http://www.festival.clcpurbalingga.id/detail.php?category=berita&id=<?php echo $satuan['id'] ?>">View</a> /<a href="<?php echo $page ?>_edit.php?id=<?php echo $satuan['id'] ?>">Edit</a> / <a data-toggle="modal" data-target="#DefaultModal<?php echo $no ?>" href="#" >Hapus</a></td>
										</tr>
