<?php
	$soalapa="juri_page"; // menentukan tabel apa yang dipilih
	$menu_title = "Juri Page description"; // menentukan judul halaman ini
		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<?php
						$id = '1';
						$satuan = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM description WHERE id = '$id' "));
					?>
					...
					<div class="the-box">
						<form id="eventform" method="post" action="<?php echo $soalapa ?>_action.php?action=edit&id=<?php echo $id ?>" class="form-horizontal" enctype="multipart/form-data" >
							...
							<?php textarea_summernote_update('Deskripsi','description',$satuan['description']) ?>							
							</fieldset>
