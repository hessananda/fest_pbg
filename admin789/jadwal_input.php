<?php
	...
	$page="jadwal"; // menentukan tabel apa yang dipilih
					...
					<div class="the-box">
						<form id="myForm" method="post" action="<?php echo $page ?>_action.php?action=input" class="form-horizontal" enctype="multipart/form-data" >
							...
							<fieldset>
								...
								<?php textbox("Judul","title","") ?>
								<?php datebox("Tanggal","tanggal","") ?>
								<?php timebox("Jam Mulai","hour_start","minute_start") ?>
								<?php timebox("Jam Selesai","hour_finish","minute_finish") ?>
                                <?php textarea_summernote("Keterangan", "content", "") ?>
                                <?php 
