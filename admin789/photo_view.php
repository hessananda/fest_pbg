<?php 
	...
	$soalapa="photo"; // menentukan tabel apa yang dipilih
	$page = 'photo';
	$menu_title = "Images Library"; // menentukan judul halaman ini
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<ol class="breadcrumb default square rsaquo sm">
                        ...
                        <li><a href="<?php echo $page.'_view.php' ?>"><?php echo $menu_title ?></a></li>
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<tbody>
								<?php
									$query = mysqli_query($con,"SELECT * FROM photo ORDER BY id DESC");
									$no = 1;
									while ($satuan = mysqli_fetch_assoc($query)) {
										...
										<tr class="odd gradeX">
											...
											<td width="30%"><img src="<?php echo '../images/library/'.$satuan['image'] ?>" width="80%" ></td>	
											<td width="10%"><?php echo $satuan['title'] ?></td>											
											<td width="35%"><div id="div1<?php echo $no ?>"><?php echo $satuan['link'].$satuan['image'] ?></div><br>
											<button id="button1" onclick="CopyToClipboard('div1<?php echo $no ?>')" class="btn btn-primary">Copy Link</button></td>
											<td width="15%">
