<?php
	...
	$page = "program_layout";
	$soalapa = "program"; //berkaitan dengan tabel, isi huruf depan dengan huruf kecil
	$tentang = "program_layout"; //berikaitan dengan tampilan, isi huruf depan dengan kapital
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-5">
							<div align="center">
								<img width="100%" height="100%" src="images/program_layout.JPG" >
						...
						<div class="col-lg-7">
							...
							<div class="the-box">
								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										<?php
											$query = "SELECT l.*, e.title FROM ".$soalapa."_layout AS l, master_".$soalapa." AS e WHERE l.master_id = e.id ";
